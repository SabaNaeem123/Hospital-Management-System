...
<section id="about" style="margin-top: 50px;">
  <h1 id="us" style="background-color:  rgb(234, 78, 55); color:white;">About Us</h1>
  <div class="about-container">
      <img src="assets/img/image3.png"  alt="Description of image" class="about-image" style="height: 550px;">
      <div class="about-text" style="position: relative; bottom: 60px">
          <h2 style="background-color: white; color: rgb(234, 78, 55); width:max-content;">Your Health, Our Commitment</h2>
          <p>
              Care is a leading healthcare provider committed to delivering high-quality medical services with a focus on patient care, advanced technology, and compassionate staff. Our mission is to ensure the well-being of all patients through our comprehensive range of services.
          </p>
          <p>
              At Care, we believe in providing a holistic approach to healthcare, focusing on preventive care, treatment, and patient education. Our experienced medical professionals and state-of-the-art facilities ensure that you receive the best possible care tailored to your needs.
          </p>
          <h3 style="background-color: white; color: rgb(234, 78, 55);">Our Vision</h3>
          <p>
              To be the most trusted healthcare provider, recognized for our commitment to patient care and community well-being.
          </p>
      </div>
  </div>
</section>
<!-- Services Section -->
<section id="services" style="padding: 40px 20px; position:relative; bottom:80px;">
    <div class="services-container">
    <h1 id="us" style="background-color: white; color: rgb(234, 78, 55);">Our Team</h1>
      <div class="card-container">
        <div class="card">
          <img src="assets/img/images (2).jpg" alt="Emergency Care" class="card-img">
          <h3>Emergency Care</h3>
          <p>24/7 emergency services with trained professionals ready to assist you at any time.</p>
        </div>
        <div class="card">
          <img src="assets/img/images (3).jpg" alt="Consultations" class="card-img1">
          <h3>Consultations</h3>
          <p>Comprehensive consultations with our specialists to ensure personalized healthcare.</p>
        </div>
        <div class="card">
          <img src="assets/img/images (1).jpg" alt="Diagnostic Services" class="card-img">
          <h3>Diagnostic Services</h3>
          <p>State-of-the-art diagnostic facilities to provide accurate and timely results.</p>
        </div>
...
.card-container {
    ...
    gap: 70px; /* Add space between cards */
  ...
  const services = [
    {
      ...
      description: "24/7 emergency services with trained professionals ready to assist you at any time."
    },
    {
      title: "Consultations",
      description: "Comprehensive consultations with our specialists to ensure personalized healthcare."
    },
    {
      title: "Diagnostic Services",
      description: "State-of-the-art diagnostic facilities to provide accurate and timely results."
    }
  ];
