...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Record Updated successfully!'); window.location='manage_patients.php';</script>";  
        exit;
    } else {
...
<form method="POST" action="edit_patient.php" id="form" style="width: 100%; max-width: 850px; margin: 1.25em 20em; background-color: rgba(255, 255, 255, 0.5); border: 1px solid #ddd; border-radius: 8px; padding-bottom: 50px;">
    ...
    <p style=" position:absolute; right: 27em; top: 34em; width: 5%; padding: 6px 13px;background: #666666; color: white; border: none; border-radius: 4px; cursor: pointer; transition: background 0.3s ease-in-out;">
        <a style= "text-decoration: none; color: white;" href="manage_patients.php">Cancel</a></p>
